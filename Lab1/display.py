...
class DisplayApp:
    ...
    def buildControls(self):
        ...
        self.colorOption.set("red") #the initial option
        ...
        #a button that calls createRandomDataPoints
        button2 = tk.Button (rightcntlframe, text="Add Points", 
